...
<html lang="en" dir="ltr">
  ...
  <script src="${pageContext.request.contextPath}/resources/details.js"></script>
    ...
    <div class="content">
    <form class="form-horizontal details_section" method="post" action="posts_mod" enctype="multipart/form-data" accept-charset="utf-8">
	    <input type="text" id="title" name="title" hidden=True/>
	    <input type="text" id="idx" name="idx" hidden=True />
	    <h3 class="title"></h3>
